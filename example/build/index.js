...
/******/ 	__webpack_require__.p = "http://localhost:4000/example/build/";
/******/
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/home/bbodnar/personal/react-responsive-carousel/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/home/bbodnar/personal/react-responsive-carousel/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	_react2.default.render(_react2.default.createElement(_component.HotReloadComponent, null), document.getElementById('react-data-list'));
	
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/home/bbodnar/personal/react-responsive-carousel/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "index.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.HotReloadComponent = undefined;
	...
	var HotReloadComponent = exports.HotReloadComponent = function (_Component) {
	  _inherits(HotReloadComponent, _Component);
	
	  function HotReloadComponent() {
	    _classCallCheck(this, HotReloadComponent);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(HotReloadComponent).apply(this, arguments));
	  }
	
	  _createClass(HotReloadComponent, [{
	    key: 'render',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cssClasses = __webpack_require__(157);
	
	var klass = _interopRequireWildcard(_cssClasses);
	
	var _reactEasySwipe = __webpack_require__(159);
	
	var _reactEasySwipe2 = _interopRequireDefault(_reactEasySwipe);
	
	var _Thumbs = __webpack_require__(161);
	
	var _cssTranslate = __webpack_require__(162);
	...
	var Carousel = exports.Carousel = function (_Component) {
	  ...
	  function Carousel(props, context) {
	    ...
	    _this.setMountState = _this.setMountState.bind(_this);
	    _this.updateSizes = _this.updateSizes.bind(_this);
	    _this.handleClickItem = _this.handleClickItem.bind(_this);
	    _this.handleOnChange = _this.handleOnChange.bind(_this);
	    _this.handleClickThumb = _this.handleClickThumb.bind(_this);
	    ...
	    _this.renderThumbs = _this.renderThumbs.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Carousel, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      var defaultImg = _reactDom2.default.findDOMNode(this.item0).getElementsByTagName('img')[0];
	    ...
	    key: 'onSwipeMove',
	    value: function onSwipeMove(delta) {
	      var _this2 = this;
	
	      var list = _reactDom2.default.findDOMNode(this.itemList);
	      ...
	      ['WebkitTransform', 'MozTransform', 'MsTransform', 'OTransform', 'transform', 'msTransform'].forEach(function (prop) {
	        list.style[prop] = (0, _cssTranslate.cssTranslate)(position, _this2.props.axis);
	      });
	    }
	  }, {
	    key: 'setMountState',
	    value: function setMountState() {
	    ...
	    value: function updateSizes() {
	      var firstItem = _reactDom2.default.findDOMNode(this.item0);
	    ...
	    key: 'handleClickItem',
	    value: function handleClickItem(index, item) {
	    ...
	    key: 'handleOnChange',
	    value: function handleOnChange(index, item) {
	    ...
	    key: 'handleClickThumb',
	    value: function handleClickThumb(index, item) {
	    ...
	    key: 'decrement',
	    value: function decrement(positions) {
	      this.moveTo(this.state.selectedItem - ((typeof positions === 'undefined' ? 'undefined' : _typeof(positions)) === Number ? positions : 1));
	    }
	  }, {
	    key: 'increment',
	    value: function increment(positions) {
	      this.moveTo(this.state.selectedItem + ((typeof positions === 'undefined' ? 'undefined' : _typeof(positions)) === Number ? positions : 1));
	    }
	  }, {
	    key: 'moveTo',
	    value: function moveTo(position) {
	      ...
	      var _position = position < 0 ? 0 : position;
	    ...
	    key: 'selectItem',
	    value: function selectItem(state) {
	      this.setState(state);
	    ...
	    value: function renderControls() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.Children.map(this.props.children, function (item, index) {
	          return _react2.default.createElement('li', { className: klass.dot(index === _this4.state.selectedItem), onClick: _this4.changeItem, value: index, key: index });
	        })
	      );
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      var transformProp = (0, _cssTranslate.cssTranslate)(currentPosition, this.props.axis);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('button', { className: klass.arrow_prev(!hasPrev), onClick: this.decrement }),
	          _react2.default.createElement(
	            'div',
	          ...
	          _react2.default.createElement('button', { className: klass.arrow_next(!hasNext), onClick: this.increment }),
	          this.renderControls(),
	          this.renderStatus()
	        ),
	        this.renderThumbs()
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/home/bbodnar/personal/react-responsive-carousel/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "cssClasses.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(160)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Thumbs = exports.Thumbs = function (_Component) {
	  _inherits(Thumbs, _Component);
	
	  function Thumbs(props, context) {
	    _classCallCheck(this, Thumbs);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Thumbs).call(this, props, context));
	
	    _this.state = {
	      selectedItem: _this.props.selectedItem,
	      hasMount: false,
	      firstItem: _this.getFirstItem(_this.props.selectedItem)
	    };
	    _this.onSwipeStart = _this.onSwipeStart.bind(_this);
	    _this.onSwipeEnd = _this.onSwipeEnd.bind(_this);
	    _this.onSwipeMove = _this.onSwipeMove.bind(_this);
	    _this.getFirstItem = _this.getFirstItem.bind(_this);
	    _this.setMountState = _this.setMountState.bind(_this);
	    _this.slideRight = _this.slideRight.bind(_this);
	    _this.slideLeft = _this.slideLeft.bind(_this);
	    _this.moveTo = _this.moveTo.bind(_this);
	    _this.handleClickItem = _this.handleClickItem.bind(_this);
	    _this.updateStatics = _this.updateStatics.bind(_this);
	    _this.renderItems = _this.renderItems.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Thumbs, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      var defaultImg = _reactDom2.default.findDOMNode(this.thumb0).getElementsByTagName('img')[0];
	      defaultImg.addEventListener('load', this.setMountState);
	    }
	  }, {
	    key: 'componentWillReceiveProps',
	    ...
	    key: 'onSwipeMove',
	    value: function onSwipeMove(deltaX) {
	      var _this2 = this;
	      ...
	      var position = currentPosition + 100 / (wrapperSize / delta) + '%';
	    ...
	    key: 'slideRight',
	    value: function slideRight(positions) {
	      this.moveTo(this.state.firstItem - ((typeof positions === 'undefined' ? 'undefined' : _typeof(positions)) === Number ? positions : 1));
	    }
	  }, {
	    key: 'slideLeft',
	    value: function slideLeft(positions) {
	      this.moveTo(this.state.firstItem + ((typeof positions === 'undefined' ? 'undefined' : _typeof(positions)) === Number ? positions : 1));
	    }
	  }, {
	    key: 'moveTo',
	    ...
	    value: function renderItems() {
	      ...
	      return _react2.default.Children.map(this.props.children, function (item, index) {
	        var itemClass = klass.item(false, index === _this3.state.selectedItem && _this3.state.hasMount);
	        ...
	        return _react2.default.createElement(
	          'li',
	          {
	            key: index,
	            ref: function ref(node) {
	              return _this3['thumb' + index] = node;
	            }, className: itemClass,
	            onClick: _this3.handleClickItem.bind(_this3, index, item)
	          },
	          img
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('button', { className: klass.arrow_prev(!hasPrev), onClick: this.slideRight }),
	          _react2.default.createElement(
	            _reactEasySwipe2.default,
	            {
	              tagName: 'ul',
	          ...
	          _react2.default.createElement('button', { className: klass.arrow_next(!hasNext), onClick: this.slideLeft })
	        )
	      );
	    }
	  }]);
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/home/bbodnar/personal/react-responsive-carousel/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Thumbs.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/home/bbodnar/personal/react-responsive-carousel/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "cssTranslate.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/autoprefixer-loader/index.js?browsers=last 2 version!./../node_modules/sass-loader/index.js?outputStyle=compressed!./carousel.scss", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/autoprefixer-loader/index.js?browsers=last 2 version!./../node_modules/sass-loader/index.js?outputStyle=compressed!./carousel.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".m4d-icon:before{display:inline-block;content:''}@font-face{font-family:'m4d-icons';src:url(" + __webpack_require__(166) + ");src:url(" + __webpack_require__(166) + "#iefix) format(\"embedded-opentype\"),url(" + __webpack_require__(167) + ") format(\"woff\"),url(" + __webpack_require__(168) + ") format(\"truetype\"),url(" + __webpack_require__(169) + "#m4d-icons) format(\"svg\");font-weight:normal;font-style:normal}[class^=\"icon-\"]:before,[class*=\" icon-\"]:before{font-family:\"m4d-icons\";font-style:normal;font-weight:normal;speak:none;display:inline-block;text-decoration:inherit;width:1em;margin-right:.2em;text-align:center;font-variant:normal;text-transform:none;line-height:1em;margin-left:.2em}.icon-right-open:before{content:\"\\E802\"}.icon-left-open:before{content:\"\\E803\"}button{outline:0;border:0;background:none}.carousel .control-arrow,.carousel.carousel-slider .control-arrow{transition:all 0.25s ease-in;opacity:0.4;filter:alpha(opacity=40);position:absolute;z-index:2;top:20px;font-family:\"m4d-icons\";background:none;border:0;font-size:32px;cursor:pointer}.carousel .control-arrow:hover{opacity:1;filter:alpha(opacity=100)}.carousel .control-disabled.control-arrow{opacity:0;filter:alpha(opacity=0);cursor:inherit;display:none}.carousel .control-prev.control-arrow{left:0}.carousel .control-prev.control-arrow:before{content:'\\E803'}.carousel .control-next.control-arrow{right:0}.carousel .control-next.control-arrow:before{content:'\\E802'}*{margin:0;padding:0;list-style:none;box-sizing:border-box}.carousel{position:relative;width:100%}.carousel img{width:100%;display:inline-block}.carousel .carousel{position:relative}.carousel .control-arrow{top:50%;margin-top:-13px;font-size:18px}.carousel .thumbs-wrapper{margin:20px;overflow:hidden}.carousel .thumbs{transition:all 0.15s ease-in;-webkit-transform:translate3d(0, 0, 0);transform:translate3d(0, 0, 0);position:relative;list-style:none;white-space:nowrap}.carousel .thumb{transition:border 0.15s ease-in;display:inline-block;width:80px;margin-right:6px;white-space:nowrap;overflow:hidden;border:3px solid #fff;padding:2px}.carousel .thumb.selected,.carousel .thumb:hover{border:3px solid #333;padding:2px}.carousel .thumb img{vertical-align:top}.carousel.carousel-slider{position:relative;margin:0;overflow:hidden}@media (min-width: 768px){.carousel.carousel-slider li{cursor:-webkit-zoom-in}}.carousel.carousel-slider .control-arrow{top:0;color:#fff;font-size:26px;bottom:0;margin-top:0;padding:5px}.carousel.carousel-slider .control-arrow:hover{background:rgba(0,0,0,0.2)}.carousel .slider-wrapper{overflow:hidden;margin:auto;width:100%}.carousel .slider-wrapper.axis-horizontal .slider{-ms-box-orient:horizontal;display:-ms-flexbox;display:-moz-flex;display:-webkit-flex;display:flex}.carousel .slider-wrapper.axis-horizontal .slider .slide{-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;-webkit-flex-flow:column;-ms-flex-flow:column;flex-flow:column}.carousel .slider-wrapper.axis-vertical{-ms-box-orient:horizontal;display:-ms-flexbox;display:-moz-flex;display:-webkit-flex;display:flex}.carousel .slider-wrapper.axis-vertical .slider{-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column}.carousel .slider{position:relative;list-style:none;width:100%}.carousel .slider.animated{transition:all 0.35s ease-in-out}.carousel .slide{min-width:100%;margin:0;padding-bottom:32px}.carousel .slide img{width:100%;vertical-align:top}.carousel .slide .legend{transition:all 0.5s ease-in-out;position:absolute;bottom:0;width:100%;background:#000;color:#fff;padding:10px;font-size:12px;text-align:center}@media (min-width: 960px){.carousel .slide{padding-bottom:0}.carousel .slide .legend{bottom:40px;margin-left:10%;width:80%;background:rgba(0,0,0,0.3);color:rgba(255,255,255,0.6);border-radius:5px;padding:10px;opacity:0}.carousel .slide.selected .legend{opacity:1}.carousel .slide:hover .legend{background:rgba(0,0,0,0.5);color:rgba(255,255,255,0.9)}}.carousel .control-dots{position:absolute;bottom:32px;margin:10px 0;text-align:center;width:100%}@media (min-width: 960px){.carousel .control-dots{bottom:0}}.carousel .control-dots .dot{transition:opacity 0.25s ease-in;opacity:0.3;filter:alpha(opacity=30);box-shadow:1px 1px 2px rgba(0,0,0,0.9);background:#fff;border-radius:50%;width:8px;height:8px;cursor:pointer;display:inline-block;margin:0 8px}.carousel .control-dots .dot.selected,.carousel .control-dots .dot:hover{opacity:1;filter:alpha(opacity=100)}.carousel .carousel-status{position:absolute;top:0;right:0;padding:5px;font-size:10px;text-shadow:1px 1px 1px rgba(0,0,0,0.9);color:#fff}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "65d4868cc9eb9678986ca411681e7fea.eot";

/***/ },
/* 167 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "fde14ce812ae2c1aad0468e533aa68f2.woff";

/***/ },
/* 168 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "83f649e72caf22253b55f35675436532.ttf";

/***/ },
/* 169 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "17a2e7bc741f572f0e0e0197047d622c.svg";
